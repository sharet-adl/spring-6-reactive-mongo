...
import guru.springframework.reactivemongo.services.BeerServiceTest;
...
class BeerEndpointTest {
    ...
    void testPatchIdNotFound() {
        webTestClient
                ...
                .body(Mono.just(BeerServiceTest.getTestBeer()), BeerDTO.class)
                .exchange()
    ...
    void testCreateBeerBadData() {
        Beer testBeer = BeerServiceTest.getTestBeer();
